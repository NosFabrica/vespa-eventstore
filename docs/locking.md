...
| `IngestStats`, `BackgroundFailures`, `GuardBloom`, `SchemaFallbacks`, `ProviderMap.cached`, `VespaEventIndex.nextUrl` | atomics / `@Volatile` | counters, flags, a cache | **already lock-free** |
